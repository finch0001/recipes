...
public class Log4j2ConfiguratorServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("info:" + request.getQueryString() + " " + System.currentTimeMillis());
        LOG.info("info:" + request.getRequestedSessionId() + " " + System.currentTimeMillis());
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        System.out.println("do post:" + request.getRequestedSessionId() + " " + System.currentTimeMillis());
        LOG.info("do post:" + request.getPathInfo() + " " + System.currentTimeMillis());
        /*
